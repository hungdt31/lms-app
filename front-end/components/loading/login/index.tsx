...
export default function LoginLooading({ label = "Đang xử lý...", size = "md" }: LoginLoadingProps) {
  ...
  return (
    <div role="status" aria-live="polite" className="flex items-center gap-3">
      ...
      <div className={`relative ${ringSizeMap[size]} animate-spin`}>
        ...
        <svg
          aria-hidden="true"
          className={`absolute inset-0 m-auto ${sizeMap[size]} text-gray-300 dark:text-gray-600 fill-blue-500`}
          viewBox="0 0 100 101"
          fill="none"
...
// Tailwind custom animation (uses existing utilities if configured)
// If you do not have animate-spin-slow in your Tailwind config, the default animate-spin still applies.
